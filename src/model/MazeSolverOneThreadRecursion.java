...
public class MazeSolverOneThreadRecursion implements Runnable {
    private int[][] mazeMatrix;
    private boolean[][] visitedCells;
    private List<int[]> successfullPath;
    private MazeSolverGUI mazeSolverGUI;

    public MazeSolverOneThreadRecursion(int[][] mazeMatrix, boolean[][] visitedCells, MazeSolverGUI mazeSolverGUI) {
...
//        lock.lock(); // Acquire the lock to ensure mutual exclusion when updating the GUI
        ...
        try {
            Thread.sleep(1000); // Delay to visualize the movement
